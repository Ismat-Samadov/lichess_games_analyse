...
└── charts/                        # All 20 analysis charts
    ...
    ├── 02_performance_by_time_control.png
    ├── 03_win_rate_vs_opponent_rating.png
    ├── 04_rating_progression.png
    ├── 05_top_openings_performance.png
    ├── 06_game_length_distribution.png
    ├── 07_termination_type_analysis.png
    ├── 08_performance_by_day_of_week.png
    ├── 09_eco_code_performance.png
    ├── 10_win_loss_streaks.png
    ├── 11_monthly_performance_trend.png
    ├── 12_rating_change_distribution.png
    ├── 13_performance_vs_game_length.png
    ├── 14_account_comparison.png
    ├── 15_best_worst_openings.png
    ├── 16_color_performance_by_tc.png
    ├── 17_rating_heatmap.png
    ├── 18_performance_by_rating_bracket.png
    ├── 19_rolling_win_rate.png
    └── 20_performance_dashboard.png
```
